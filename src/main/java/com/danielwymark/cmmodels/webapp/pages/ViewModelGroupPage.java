...
public record ViewModelGroupPage(List<PointedModel> models) implements Renderable {
    ...
    public void render(Context ctx) {
        ...
        List<String> allModels = models.stream().map(PointedModel::modelNumber).toList();
